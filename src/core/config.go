...
type Configuration struct {
	...
	Go struct {
		...
		GoTool    string `help:"Sets the location of the please_go_tool tool that is used to help various parts of Go compilation (for example, templating test main files)." var:"GO_TEST_TOOL"`
