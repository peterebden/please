...
type Configuration struct {
	...
	Go struct {
		...
		GoGetExplicitDeps bool   `help:"Indicates that explicit dependencies will be passed to go_get. Is required for Go 1.10 and will be required everywhere from v12+." var:"GO_GET_EXPLICIT_DEPS"`
