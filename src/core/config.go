...
func DefaultConfiguration() *Configuration {
	...
	config.Go.ProvideTool = "please_go_provide"
...
type Configuration struct {
	...
	Go struct {
		...
		ProvideTool   string `help:"Sets the location of the please_go_provide tool that provides BUILD files for go_module rules." var:"GO_PROVIDE_TOOL"`
...
func (config *Configuration) ApplyOverride(k, v string) error {
