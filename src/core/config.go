...
func ReadConfigFiles(filenames []string, profile string) (*Configuration, error) {
	...
	defaultPath(&config.Go.BuildTool, config.Please.Location, "please_go_build")
...
type Configuration struct {
	...
	Go struct {
		...
		BuildTool     string `help:"The binary to use for building Go code, especially go_get rules." var:"GO_BUILD_TOOL"`
