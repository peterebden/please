...
var opts = struct {
	...
	Graph        cli.Filepath  `short:"g" long:"graph" description:"Graph file, as exported from plz query graph. If given then existing dependencies in it will be integrated when using --build_rules."`
	Args         struct {
