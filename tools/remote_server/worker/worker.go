...
func (w *worker) ExecuteTest(ctx context.Context, req *pb.RemoteTestRequest) (*pb.RemoteTestResponse, error) {
	...
	code, stderr, err := w.runTest(ctx, req)
	if err != nil {
		return &pb.RemoteTestResponse{Error: err.Error()}, nil
	}
	return &pb.RemoteTestResponse{
		ExitCode: int32(code),
...
func (w *worker) runTest(ctx context.Context, req *pb.RemoteTestRequest) (int, []byte, error) {
